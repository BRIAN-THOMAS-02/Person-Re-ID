...
transform_train_list = [
        ...
        transforms.ToTensor(),
        transforms.Normalize([0.485, 0.456, 0.406], [0.229, 0.224, 0.225])  # we see there are 2 square brackets, the 1st one is for mean and 2nd one is for SD. Basically Normalize is the same as Standard Scalar, where we get unit variance and mean=0
        ]

transform_val_list = [
        transforms.Resize(size=(h, w), interpolation=3),  #Image.BICUBIC transformation is used here as interpolation=3
        transforms.ToTensor(),
