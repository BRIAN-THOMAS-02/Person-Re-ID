...
print(current_path)
two_folders_up = os.path.abspath(os.path.join(current_path, "..", ".."))
print(two_folders_up)
dataset_path = os.path.join(two_folders_up, 'Datasets\Market-1501\Market\pytorch')
print(dataset_path)

parser = argparse.ArgumentParser(description='Test')
parser.add_argument('--gpu_ids', default='0', type=str, help='gpu_ids: e.g. 0  0,1,2  0,2')
parser.add_argument('--which_epoch', default='last', type=str, help='0,1,2,3...or last')
parser.add_argument('--test_dir', default=dataset_path, type=str, help='./test_data')
